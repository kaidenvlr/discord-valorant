...
from utils.backup.db_fetch import fetch_user, fetch_notify
...
class ValorantBot(commands.Bot):
    ...
    def __init__(self) -> None:
        self.bot = super().__init__(command_prefix=BOT_PREFIX, case_insensitive=True, intents=intents)
    ...
    async def on_ready(self) -> None:
        ...
        await self.change_presence(activity=discord.Activity(type=activity_type, name="ограбление"))
